...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    def test_when_village_jpg_then_succeeds(self):
        ...
        assert self.outputsaver.verify_pdl_crc(Current_crc_value), "fail on crc mismatch"        logging.info("JPEG Performance village Page - Print job completed successfully")
