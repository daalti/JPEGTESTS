...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_testfiles_text_ascii_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:7170d527-3b90-4e83-97da-43033e5dc912
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl5_testfiles_text_ascii_file_then_succeeds(self):
