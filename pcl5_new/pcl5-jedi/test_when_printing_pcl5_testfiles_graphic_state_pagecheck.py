...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_testfiles_graphic_state_pagecheck_file_then_succeeds
        +test:
            +title: test_pcl5_testfiles_graphic_state_pagecheck
            +guid:66c6a933-2a0d-48a1-af04-63c97af99a41
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl5_testfiles_graphic_state_pagecheck_file_then_succeeds(self):
