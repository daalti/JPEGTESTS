...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_testfiles_graphic_state_pageclip_file_then_succeeds
        +test:
            +title: test_pcl5_testfiles_graphic_state_pageclip
            +guid:f09ee436-c59e-46b5-92ca-4674be575965
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl5_testfiles_graphic_state_pageclip_file_then_succeeds(self):
