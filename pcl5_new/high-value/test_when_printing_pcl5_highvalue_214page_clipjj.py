...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_highvalue_214page_clipjj_file_then_succeeds
        +test:
            +title: test_pcl5_highvalue_214page_clipjj
            +guid:c58c0b32-925d-49e6-b842-fe9f140fa3a2
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl5_highvalue_214page_clipjj_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('d6fccada3771a6dcea6573c3b8e874a66e75939fd7e05fb911b37797a3c22c06')
