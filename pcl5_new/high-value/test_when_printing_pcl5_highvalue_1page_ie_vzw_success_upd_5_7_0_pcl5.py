...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    """
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_highvalue_1page_ie_vzw_success_upd_5_7_0_pcl5_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:46b05bf1-d452-431a-92ee-068535111cd2
            +dut:
                +type:Simulator
    ...
    def test_when_using_pcl5_highvalue_1page_ie_vzw_success_upd_5_7_0_pcl5_file_then_succeeds(self):
        ...
        current_crc = self.outputsaver.get_crc()
        assert self.outputsaver.verify_pdl_crc(current_crc)
