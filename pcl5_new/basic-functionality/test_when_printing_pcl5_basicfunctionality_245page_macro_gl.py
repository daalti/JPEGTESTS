...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_basicfunctionality_245page_macro_gl_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:f29c66fa-43c5-44e1-ae5c-bc928d0ff16a
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl5_basicfunctionality_245page_macro_gl_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('64cfbac5616eeaf2c7479acccac37f2bf5ff12bd144f830d1ad4d670fbfdd873')
