...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl5_basicfunctionality_34page_currpatt_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c6d8a7ec-58b7-438d-96fc-1ee075f72bc0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl5_basicfunctionality_34page_currpatt_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('c30b1cca8e2eedf77feaca27d803202f2be2566c1a46e3ee32b7c855062ae963')
