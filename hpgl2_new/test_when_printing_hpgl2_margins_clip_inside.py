...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    """
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_hpgl2_margins_clip_inside_file_then_succeeds
        +test:
            +title:test_hpgl2_margins_clip_inside
            +guid:c445f95c-d319-4dbf-9e16-3675ce18b673
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=HPGL2
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_hpgl2_margins_clip_inside_file_then_succeeds(self):

        logging.info('Running test_hpgl2_margins_clip_inside')

        outputverifier.outputsaver.operation_mode('CRC')
        job_id = self.print.raw.start('f21d571f555691fbebc8e72272ffedfa2135e0375e4cfa5e151e803569f0267f')
