...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_urf_a4_test_pattern_color_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:7f797cbc-17e9-4cf7-ab5b-d038baa9585a
        +dut:
            +type:Simulator
...
"""
def test_urf_a4_test_pattern_color_page(setup_teardown, print_emulation, configuration, printjob, outputsaver,udw,tray):
    ...
    printjob.print_verify('e5060d676799e7168e32b83b62951186cef7bd70473daf2cb63bd1c8351e3b1a')
