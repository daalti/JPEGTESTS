...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_render_intent_4_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:12944023-1363-4aaf-a026-9cf1d02098b1
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_render_intent_4_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('9e2aacf9b339519a93db7657921de351642653776b93885fa81656319fc689fa')
    outputsaver.save_output()

    logging.info("PWG Cloud Print-Render Intent-4 pagecompleted successfully")
