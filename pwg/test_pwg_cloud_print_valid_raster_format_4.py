...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_valid_raster_format_4_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:6ae6674d-ad92-4b8f-8a93-e03b777793a0
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_valid_raster_format_4_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('2db8056eefa5a72b885e76181720b013f14a4fce311cc76acb008d2e71e51cc6')
    outputsaver.save_output()

    logging.info("PWG Cloud Print-Valid Raster Format-4completed successfully")
