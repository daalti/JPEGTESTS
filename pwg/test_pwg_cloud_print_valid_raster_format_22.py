...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_valid_raster_format_22_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:605e0ad4-5fd6-42d2-adcf-60004a0eaa79
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_valid_raster_format_22_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('acd1927984e9ed031fc4dac26cbd29112725a05e235b263aa31abdb2465c488c')
    outputsaver.save_output()

    logging.info("PWG Cloud Print Valid Raster Format-22 Page- Print job completed successfully")
