...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_valid_raster_format_9_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:fd7917f9-0feb-4daf-a67e-753698c6ebd5
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_valid_raster_format_9_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('acd1927984e9ed031fc4dac26cbd29112725a05e235b263aa31abdb2465c488c')
    outputsaver.save_output()

    logging.info("PWG Cloud Print Valid Raster Format-9 Page- Print job completed successfully")
