...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_valid_raster_format_12_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:29e96958-ed42-4882-b3a9-b8c0ac816f55
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_valid_raster_format_12_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('5513c79efb88892bab44579d5f332704c199f9fc72112eb65695ec24f64210e0')
    outputsaver.save_output()

    logging.info("PWG Cloud Print-Valid Raster Format-12completed successfully")
