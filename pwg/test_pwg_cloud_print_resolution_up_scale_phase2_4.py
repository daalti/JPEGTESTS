...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_resolution_up_scale_phase2_4_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:1640cd70-68c6-4ab6-acc3-b41837d06faf
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_resolution_up_scale_phase2_4_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('b183486585196e3b50bf96c0a3e0ed9d6b4fce16a7217142890faa0566e13f53')
    outputsaver.save_output()

    logging.info("PWG Cloud Print Resolution Up Scale Phase2-4completed successfully")
