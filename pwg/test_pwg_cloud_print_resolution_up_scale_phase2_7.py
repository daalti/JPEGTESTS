...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_resolution_up_scale_phase2_7_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:9d827df3-1c4c-45c1-a3a1-3c96aa528452
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_resolution_up_scale_phase2_7_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('acd1927984e9ed031fc4dac26cbd29112725a05e235b263aa31abdb2465c488c')
    outputsaver.save_output()

    logging.info("PWG Cloud Print Resolution Up Scale Phase2-7completed successfully")
