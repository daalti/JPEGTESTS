...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_resolution_up_scale_phase2_5_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:d66443d0-70da-4aa7-8816-54f704a44ed7
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_resolution_up_scale_phase2_5_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('b183486585196e3b50bf96c0a3e0ed9d6b4fce16a7217142890faa0566e13f53')
    outputsaver.save_output()

    logging.info("PWG Cloud Print Resolution Up Scale Phase2-5completed successfully")
