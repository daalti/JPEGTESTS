...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pwg_cloud_print_resolution_up_scale_phase2_2_page
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:d3fb2819-82ca-4dd9-b2b2-fd9c2d85ee0c
        +dut:
            +type:Simulator
...
"""
def test_pwg_cloud_print_resolution_up_scale_phase2_2_page(setup_teardown, printjob, outputsaver):
    printjob.print_verify('449c80c848e1cff57c4e1e58defc551459c69e2643ccd95cebb6b5e8aa9557cd')
    outputsaver.save_output()

    logging.info("PWG Cloud Print Resolution Up Scale Phase2-2completed successfully")
