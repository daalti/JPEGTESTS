...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_legal_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:8b340c05-ae32-4c75-b640-3a7b27b07296
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_legal_color_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('e9de59dd51a3ee051177230df3724570b15da790a4b0371a46c9f855a8b0e947')
