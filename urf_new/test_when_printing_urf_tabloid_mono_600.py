...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_tabloid_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c7f9f04d-138e-4a61-86a7-b03623e7e625
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_tabloid_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('ebc34fb5d2dc851b9a5fc928ac5747c5a71449449efc3b161fcaa1c1a15d5480')
