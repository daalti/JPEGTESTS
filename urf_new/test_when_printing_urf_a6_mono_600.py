...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a6_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:4113308d-4b5e-469b-b1ce-5aaf3d0ca7e2
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a6_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('56fae7357ce1896130fc0f7f43782e57e70b8fa3ea1937396f969890d3339bb5')
