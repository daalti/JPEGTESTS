...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a4_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:8ad48cff-2618-4330-b863-5f3b17c27ba0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a4_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('1ce8aea35e34f239040389ca211cfab80a23aa17042d83ea0f34234ac72f7cf0')
