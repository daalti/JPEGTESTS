...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a4_color_300_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:e82a27f2-e019-4be1-8533-de6a35f82798
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a4_color_300_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('16f1c874037c57f7633b6a6c8e3e9bf362b0630d977c01e1c8c46d1cfa6d8cd3')
