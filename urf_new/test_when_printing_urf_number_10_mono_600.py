...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_number_10_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:34244b3f-426c-4ecb-9953-e00a64697ce2
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_number_10_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('c360d1c5ef0079781d4a5037ab3bf35a66df365cbb4e3edd610e3576fb3b3df1')
