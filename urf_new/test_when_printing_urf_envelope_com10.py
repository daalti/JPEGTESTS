...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_envelope_com10_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:830a022b-5a81-436c-bf98-409b92411ca9
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_envelope_com10_file_then_succeeds(self):
