...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_index_4x6_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c568d3b5-276b-45af-a402-29c5935a57a8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_index_4x6_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('36044297b3448dad4d9efcf682a6b2e984852dbcc69e0543b50623d9f642aeca')
