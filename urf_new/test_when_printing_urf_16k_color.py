...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_16k_color_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:e17148ba-78a9-4973-aa59-911223cc9b41
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_16k_color_file_then_succeeds(self):
