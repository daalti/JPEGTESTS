...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a3_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:a333d8be-34dc-4edc-8f8c-97fac71f3909
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a3_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('faf1231ecb1058fc5b3f96e589450bb21c40690349c0176a64b40a3f0bd84447')
