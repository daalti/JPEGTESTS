...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a4_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_urf_a4
            +guid:bb13f6d4-277c-4577-b09c-122a1d413f60
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a4_file_then_succeeds(self):
