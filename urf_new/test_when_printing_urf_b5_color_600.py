...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_b5_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:a941c4d2-8601-4f3c-8dc6-a0a794caabe4
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_b5_color_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('50d6152543c50c657b440f0f7adac94c2518b01fb928f261aa688f53b69094f6')
