...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_11x17_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:062ed037-c661-4501-a2e8-eb71227b408a
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_11x17_color_600_file_then_succeeds(self):
        job_id = self.print.raw.start('cb3e64b9121a3a57179109cdee178a2079fb75aaf9fd9d28a43955886c63c973')
