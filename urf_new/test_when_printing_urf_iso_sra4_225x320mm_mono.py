...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_iso_sra4_225x320mm_mono_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:75f54adb-7ba6-403b-8f42-7c431e15e34b
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_iso_sra4_225x320mm_mono_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('333b7c8dc34ea7cb1c0d3d2f43bde6fae6829b03f45f0f2a15cf9d761e67de97')
