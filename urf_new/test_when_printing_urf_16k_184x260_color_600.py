...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_16k_184x260_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:bbeb0f7e-4ab2-4684-94c9-e4ee29865fc4
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_16k_184x260_color_600_file_then_succeeds(self):
        default = self.media.tray.get_default_source()
        if self.media.tray.is_size_supported('om_16k_184x260mm', default):
            self.media.tray.configure_tray(default, 'om_16k_184x260mm', 'stationery')
        elif self.media.tray.is_size_supported('custom', default):
            self.media.tray.configure_tray(default, 'custom', 'stationery')

        job_id = self.print.raw.start('f2d9d2c68fdda890cfc266c4ba541540749a8a5255f51a576315775f520274a7')
