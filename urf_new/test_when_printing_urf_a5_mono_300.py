...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a5_mono_300_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:0d73fe1a-f22d-4fc6-aaf6-fdd392349ea0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a5_mono_300_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('f1c8ad7c7973ddb47ec9f6daba18dcc9c7ade2aec4010a1d3d91d82b34620a32')
