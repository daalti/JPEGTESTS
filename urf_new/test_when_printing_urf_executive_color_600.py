...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_executive_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:26c490f6-a818-4150-b86c-dcd1d22fe6ad
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_executive_color_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('0d596a0a1a49bf52626a68b80c78720cd86f9e523e4c846e285032713ad24efb')
