...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a3_color_300_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:000ccdfc-47b6-4b48-b0b5-c4c16805204e
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a3_color_300_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('a9df31fe77f816529f0be95b0ccc27e9bebe9367fbb12659a1a0cecba3e92094')
