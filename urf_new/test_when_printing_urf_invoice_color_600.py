...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_invoice_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:05f164f1-c7de-44e8-bba3-36fdeea65080
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_invoice_color_600_file_then_succeeds(self):
