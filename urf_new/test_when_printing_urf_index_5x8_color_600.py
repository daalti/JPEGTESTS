...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_index_5x8_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:04ff499c-dc7a-4c0f-92da-e11450bf31d9
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_index_5x8_color_600_file_then_succeeds(self):
        ...
        elif self.media.tray.is_size_supported('na_index-5x8_5x8in', default):
