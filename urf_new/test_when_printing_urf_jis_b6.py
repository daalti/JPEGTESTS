...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_jis_b6_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c156d5e4-addb-469c-9bde-a7e88e5b766b
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_jis_b6_file_then_succeeds(self):
        ...
        self.outputsaver.validate_crc_tiff()
        job_id = self.print.raw.start('626d7d9d260895152c22a4fd7f02c8be6140ecb23e056e85161d4c43b165679e')
