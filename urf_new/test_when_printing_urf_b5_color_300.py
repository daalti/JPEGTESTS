...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_b5_color_300_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:4f729b74-2ab2-47d2-9e7f-d79e9c8fc923
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_b5_color_300_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('5846af426a0a28f710ff4bcf1c1ede8a0da018873f21bd1c8cf9bf86fe1be211')
