...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_prc_8k_273x394_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:225be2cf-7aaf-4e21-aa76-a334a892adb1
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_prc_8k_273x394_color_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('ae7c3a34da9db8437ec5e57395ab37136f91cd0963b25b081bc304cf4c942d12')
