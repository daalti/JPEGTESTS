...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_oufuku_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:15beb3b1-913e-4eb2-ad0d-64008b5293c2
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_oufuku_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('0867686df0b88a1eeb94e4eeeb1f5919de8145ff7b408bbd45f396696a16afe2')
