...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_com_10_color_300_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:6c65e291-4f73-46f3-8f80-c139dc177c67
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_com_10_color_300_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('6864568ba0cd1a401a56ef797e931574e86566ce255a7650e75fc780e3b2f126')
