...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_a5_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:35e626dd-98ec-41a4-ae8d-aa3b7f5e3994
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_a5_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('d31ef931188041d2c7a93d823b704d0d88fb318106ef85487838b15cc1eeebca')
