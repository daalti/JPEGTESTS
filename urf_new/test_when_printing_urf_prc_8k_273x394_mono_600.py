...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_prc_8k_273x394_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:d074a805-d761-48d4-a6ba-1d1036737c2a
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_prc_8k_273x394_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('6227822ecaeb05b68022dcf47d15d14f01793b161f663ac7da2bd8773a62d9d8')
