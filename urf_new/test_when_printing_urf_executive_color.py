...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_executive_color_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:12486ca2-0f97-4bbb-a09c-941d0e0e212d
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_executive_color_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('2488929b9327c6751847274ae39a814dda79c6e2adf2a8582082ce8121216078')
