...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_dl_color_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:d51dc4ac-0b1b-4f8b-b78b-8c7eb46f25e3
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_dl_color_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('3731ffdf27c9e2cca62860026056429caed469a82c8a7563c7d786f1aff7cb26')
