...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_index_5x8_mono_600_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:21fd88ed-df87-42ce-ab30-003f9bbc8ff2
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_index_5x8_mono_600_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('94b6d3da4945089dd0b3b9e7424155af19bac2ab2bd41f452cf4b8c794877bc8')
