...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_letter_copies_2_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:63a54f77-e497-4297-9854-6009546d4b56
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_letter_copies_2_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('1448cb1193e618d83f84fa66a2f9a03e1d0a0ce8fd916bed87421052f50dcb70')
