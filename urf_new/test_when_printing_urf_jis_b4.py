...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_jis_b4_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:27b366ed-2876-4fb7-93c6-3bf35e97003b
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_jis_b4_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('bcc2323674895e324ec89e1517fdb41386076f4040b3c4c9566ed49a47b06e90')
