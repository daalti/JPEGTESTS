...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_urf_executive_color_300_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:9a969e49-65ea-404e-a454-e970423a3e09
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_urf_executive_color_300_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('09184ccd524a9216b6063098ef911e0212e8be0f877a802a6ff015606f9c74a3')
