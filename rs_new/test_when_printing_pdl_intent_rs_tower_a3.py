...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pdl_intent_rs_tower_a3_file_then_succeeds
        +test:
            +title:test_pdl_intent_rs_tower_a3
            +guid:f4eedca6-acf9-488f-aa51-fc12544fc65d
            +dut:
    ...
    """
    def test_when_using_pdl_intent_rs_tower_a3_file_then_succeeds(self):
