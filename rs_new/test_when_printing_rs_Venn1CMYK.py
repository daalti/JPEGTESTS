...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_rs_Venn1CMYK_file_then_succeeds
        +test:
            +title:test_rs_Venn1CMYK
            +guid:f50d1502-9e33-4e1c-ba62-4cb013800f4a
            +dut:
    ...
    """
    def test_when_using_rs_Venn1CMYK_file_then_succeeds(self):
