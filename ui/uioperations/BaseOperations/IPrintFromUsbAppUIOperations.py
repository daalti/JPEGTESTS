#########################################################################################
# @file      IPrintFromUsbAppUIOperations.py
# @author    Tao Kong (tao.kong@hp.com)
# @date      21-07-2021
# @brief     Interface for all the Print from USB UI navigation methods
# (c) Copyright HP Inc. 2020. All rights reserved.
###########################################################################################
import sys

class IPrintFromUsbAppUIOperations(object):
    ...
    def goto_print_from_usb_menu(self):
        """
        Purpose: navigate to printfromusb from menu Print .
        Ui Flow: Home_Print -> USBPrint_NoFileFound/USBPrint_PrintFromUSBHom
        @return:
        """
        raise NotImplementedError('Unimplemented method %s' % sys._getframe().f_code.co_name)
    ...
    def select_print_file_or_folder_by_name(self, name: str):
        """
    ...
    def set_print_margins_options(self, net, print_margins_options="clip_from_contents"):
        ...
        @param net:
        @param print_margins_options:str -> clip_from_contents/add_to_contents
        @return:
        """
        raise NotImplementedError('Unimplemented method %s' % sys._getframe().f_code.co_name)
    ...
    def set_paper_source_options(self, net, paper_source_options="roll1", locale: str = "en-US"):
        """
        Set paper source option
        @param net:
        @param paper_source_options: str -> Roll
        @param locale:
        @return:
        """
        raise NotImplementedError('Unimplemented method %s' % sys._getframe().f_code.co_name)
