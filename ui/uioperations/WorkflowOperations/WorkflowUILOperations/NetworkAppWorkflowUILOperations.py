...
class NetworkAppWorkflowUILOperations(NetworkAppWorkflowUICommonOperations):

    def __init__(self, spice):
        self.maxtimeout = 120
        self._spice = spice
        self.workflow_common_operations = spice.basic_common_operations
        self.home_menu_workflow_l_operations = MenuAppWorkflowUILOperations(self._spice)

    def goto_settings_menu(self):
        '''Go to settings menu'''
        self.home_menu_workflow_l_operations.goto_menu_settings(self._spice)
