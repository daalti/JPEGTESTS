...
class NetworkAppWorkflowUIMOperations(NetworkAppWorkflowUICommonOperations):
    ...
    def goto_network_settings_menu(self):
        ...
        time.sleep(5)
        self.workflow_common_operations.goto_item("#networkSettingsSettingsTextImage", "#settingsMenuListListViewlist1",True, scrollbar_objectname="#settingsMenuListListViewlist1ScrollBar")
    ...
    def get_default_IPV4_state(self):
        ...
        self._spice.wait_for('#networkSettingsMenuList')
        time.sleep(1)
        default_ipv4_state = self._spice.query_item("#cnxIPv4Enable_WFSettingsSwitch")["checked"]
    ...
    def get_default_IPV6_state(self):
        ...
        self._spice.wait_for('#networkSettingsMenuList')
        time.sleep(1)
        default_ipv6_state = self._spice.query_item("#cnxIPv6Enable_WFSettingsSwitch")["checked"]
