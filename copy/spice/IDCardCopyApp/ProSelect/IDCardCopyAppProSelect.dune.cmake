DUNE_ADD_FLAVOR()
    DUNE_SPICE_DATA_FILTER_FLAT_BUFFER_FOR(JSON ${DUNE_BASE_PATH}/copy/spice/IDCardCopyApp/ProSelect/spiceData/IDCardCopySettings.json FBS ${DUNE_BASE_PATH}/spice/guiCore/pub/MenuNodes.fbs)
    DUNE_LINK_LIBRARIES(
                        spice/guiCore
                        spice/ux/proSelect
...
set (TEST_RESOURCES_DIR ${DUNE_BASE_PATH}/copy/spice/IDCardCopyApp/ProSelect/test/testResources)
