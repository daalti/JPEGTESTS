...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_jpeg_photoimages_10_corrupt_dpof_a2
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
        ...
        +test_type:Positive
    +test:
        +title:test_jpeg_photoimages_10_corrupt_dpof_a2
        +guid:746817c8-cba4-4ce8-b1e6-85d6acd85642
        +dut:
            +type:Simulator
...
"""
def test_jpeg_photoimages_10_corrupt_dpof_a2(setup_teardown, printjob, outputsaver,tray):
