# dunetuf/ui/new/dune/workflow/xl/locators/copy.py
...
class CopyLoc:
    ...
    # ------------------------------- Views / Panels --------------------------------- #
    view_copy_settings: Final = CSS("#copySettingsPage_list1")
    ...
    opt_content_linedraw: Final = CSS("#ComboBoxOptionslineDrawing")
