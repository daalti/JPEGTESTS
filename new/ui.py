...
from dunetuf.ui.new.shared.enums import Platform, UIType, UISize, Feature, Logic, norm_platform, norm_uitype, norm_uisize
...
def _logic_modpath(platform: Platform, uitype: UIType, uisize: UISize, logic: Logic) -> str:
    ...
    return f"dunetuf.ui.new.{platform.value}.{uitype.value}.{uisize.value}.{logic.value}_logic"
