...
class CopyOps(Protocol):
    ...
    def goto_copy_resolution_list(self) -> None:
        ...
        raise NotImplementedError("goto_copy_resolution_list not implemented. Should be implemented by subclass.")

    def goto_copy_content_type_list(self) -> None:
        """Navigate to copy content type list."""
        raise NotImplementedError("goto_copy_content_type_list not implemented. Should be implemented by subclass.")

    def goto_copy_original_paper_list(self) -> None:
        """Navigate to copy original paper type list."""
        raise NotImplementedError("goto_copy_original_paper_list not implemented. Should be implemented by subclass.")
