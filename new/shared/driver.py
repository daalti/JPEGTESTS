...
class QmlDriverConfig:
    ...
    human_mode: bool = field(default_factory=lambda: bool(os.environ.get("QMLTEST_HUMAN", False)))
    timeout_factor: float = field(default_factory=lambda: float(os.environ.get("TUF_TIMEOUT_FACTOR", "1.0")))
