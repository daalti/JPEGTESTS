...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pcl3gui_unsupported_1200dpi_beam
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:024bf885-f117-41c3-bb27-6fd5f21824c2
        +dut:
            +type:Simulator
...
def test_pcl3gui_unsupported_1200dpi_beam(setup_teardown, printjob, outputsaver):
...
def test_pcl3gui_unsupported_1200dpi_jupiter(setup_teardown, printjob, outputsaver):
...
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_pcl3gui_unsupported_media_type_1200dpi_jupiter(setup_teardown, printjob, outputsaver, tray):

    if tray.is_type_supported(MediaType.photographicglossy, 'roll-1'):
        tray.configure_tray('roll-1', 'custom', MediaType.photographicglossy)
