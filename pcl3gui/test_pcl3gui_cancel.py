...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pcl3gui_internal_cancel_fuzzedjob
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:2bd1c1ac-445d-44dd-8487-b7b3cb88580b
        +dut:
            +type:Simulator
...
"""
def test_pcl3gui_internal_cancel_fuzzedjob(printjob):
...
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_pcl3gui_user_cancel(printjob):
...
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_pcl3gui_internal_cancel(printjob):
    logging.debug("Perform print job")
