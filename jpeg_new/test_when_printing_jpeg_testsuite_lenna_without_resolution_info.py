...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_lenna_without_resolution_info_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
    ...
    """
    def test_when_using_lenna_without_resolution_info_file_then_succeeds(self):
