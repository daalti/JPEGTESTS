...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_photoimages_JPEG_greater3mb_DSC00452_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
    ...
    """
    def test_when_using_photoimages_JPEG_greater3mb_DSC00452_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('1c7dfd4eed3183b26bda9eb99ffceb52be901e7e6e2f4e12a0b62c1e753c0a1f')
