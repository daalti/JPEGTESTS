...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_photoimages_300_2000_Quality_Test_Photos_50_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
    ...
    """
    def test_when_using_photoimages_300_2000_Quality_Test_Photos_50_file_then_succeeds(self):

        job_id = self.print.raw.start('143829ed3af12fe47429e199b4d725b6bb4e1ce44138debc6e5c2e06899d0393')
