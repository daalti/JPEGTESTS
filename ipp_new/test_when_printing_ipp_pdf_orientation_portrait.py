...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_orientation_portrait_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_orientation_portrait
                    +guid:bab393c5-cb2a-460d-b26f-d3daa9219dba
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_orientation_portrait_file_then_succeeds(self):
