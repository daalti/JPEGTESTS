...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_media_size_a3_file_then_succeeds
        +test:
            +title:test_ipp_jpg_media_size_a3
            +guid:9bd28ec8-59bc-4380-be0c-d1694a8667a9
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_media_size_a3_file_then_succeeds(self):
