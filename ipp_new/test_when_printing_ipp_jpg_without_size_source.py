...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_without_size_source_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:78571105-fdb5-471d-832c-908ab5f14776
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_without_size_source_file_then_succeeds(self):
