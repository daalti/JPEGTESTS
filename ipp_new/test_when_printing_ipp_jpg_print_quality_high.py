...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_quality_high_file_then_succeeds
        +test:
            +title:test_ipp_jpg_print_quality_high
            +guid:5ae24780-0c36-4913-90bf-82ba77809365
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_quality_high_file_then_succeeds(self):
