...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_pdf_sides_two_sided_short_edge_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:9a23fa4b-678c-4747-8937-0b944f8d8b23
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_pdf_sides_two_sided_short_edge_file_then_succeeds(self):
        ipp_test_attribs = {}
