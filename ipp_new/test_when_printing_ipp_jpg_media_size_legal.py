...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_media_size_legal_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:6656e771-2e55-483b-9f1c-7ec78246b2b4
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_media_size_legal_file_then_succeeds(self):
