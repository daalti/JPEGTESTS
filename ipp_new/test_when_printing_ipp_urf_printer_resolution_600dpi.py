...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_printer_resolution_600dpi_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:b178ff90-8758-4102-bedf-b50c4ef47c89
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_printer_resolution_600dpi_file_then_succeeds(self):
        ipp_test_attribs = {}
