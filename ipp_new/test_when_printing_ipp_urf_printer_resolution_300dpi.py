...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_printer_resolution_300dpi_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:4428670b-a670-472e-b471-c73d44e1ab73
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_printer_resolution_300dpi_file_then_succeeds(self):
        ipp_test_attribs = {}
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_test_attribs)

        job_id = self.print.ipp.start(ipp_test_file, '220dcce1b931685a6564c8aa1223ff56f8781d21c4414c01c21094fa0974f4a5')
