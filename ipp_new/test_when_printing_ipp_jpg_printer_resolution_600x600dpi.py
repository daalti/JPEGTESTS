...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_printer_resolution_600x600dpi_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:700bcad6-194c-4370-805a-e1f5d84266d0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_printer_resolution_600x600dpi_file_then_succeeds(self):
