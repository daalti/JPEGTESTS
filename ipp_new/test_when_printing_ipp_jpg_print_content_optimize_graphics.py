...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_content_optimize_graphics_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:db32a1eb-0344-4d77-b2ae-f387ca74acb1
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_content_optimize_graphics_file_then_succeeds(self):
