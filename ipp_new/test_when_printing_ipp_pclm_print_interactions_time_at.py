...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_print_interactions_time_at_file_then_succeeds
        +test:
            +title:test_ipp_pclm_print_interactions_time_at
            +guid:65244ce3-bc9a-4150-b5fe-fe24e2497244
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_print_interactions_time_at_file_then_succeeds(self):
