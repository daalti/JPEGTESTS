...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_airprint_mac_pages_mediasize_legal_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:307b9c9d-67c9-468a-8469-6b520c150a0e
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_airprint_mac_pages_mediasize_legal_file_then_succeeds(self):
        ipp_test_attribs = {}
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_test_attribs)

        job_id = self.print.ipp.start(ipp_test_file, '6cec019c068346ae4b8b6fdd3d7a4e0ba9c9b8e0a9764c60c6baa62e83448c41')
