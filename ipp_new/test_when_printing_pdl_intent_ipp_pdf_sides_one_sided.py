...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_pdf_sides_one_sided_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:cabd4db6-e04c-4a5e-a3a5-f11c82391a99
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_pdf_sides_one_sided_file_then_succeeds(self):
        ipp_test_attribs = {}
