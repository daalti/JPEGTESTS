...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_jpeg_blank_page_gray_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:35b32b82-db11-408a-a4af-f6bf9ca42cc5
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_jpeg_blank_page_gray_file_then_succeeds(self):
        ...
        job_id = self.print.ipp.start(ipp_test_file, '7e0798c32b24bce14ca8c65fbbf8f6672506e2c047ce24ebc6eb2d2f8d66449c')
