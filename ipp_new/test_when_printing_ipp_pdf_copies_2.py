...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_copies_2_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_copies_2
                    +guid:e4cd2b34-52e2-4aaf-a6d7-2c8c30145348
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_copies_2_file_then_succeeds(self):
