...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_output_bin_face_up_fedility_default_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:80adc96d-a5e6-4d2d-8090-56c828f058f9
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_output_bin_face_up_fedility_default_file_then_succeeds(self):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test:
            ...
            +guid:c200dbb7-4bb7-497f-9792-841cf8568601
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=PCLm & PrintProtocols=IPP & MediaPath=FaceUp
        +overrides:
