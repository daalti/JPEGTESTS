...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_compression_valid_file_then_succeeds
        +test:
            +title:test_ipp_pclm_compression_valid
            +guid:42165377-680d-43ce-bfa1-8444b69bf408
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_compression_valid_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        
        compression_valid_test_file = "/code/tests/print/pdl/ipp/attributes/compression_valid.test"
        job_id = self.print.ipp.start(compression_valid_test_file, 'b816ad25f9828ae2c20432e2aac4d5b63991c97b50615a5917452cce74bc21a8')
