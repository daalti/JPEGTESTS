...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_output_bin_face_down_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_output_bin_face_down
                    +guid:d9347757-f4b9-4b04-8777-49e50d87168e
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_output_bin_face_down_file_then_succeeds(self):
