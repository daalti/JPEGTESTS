...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_orientation_requested_reverse_portrait_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:cd58b564-2ad3-4e64-b433-a3513894abbc
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_orientation_requested_reverse_portrait_file_then_succeeds(self):
