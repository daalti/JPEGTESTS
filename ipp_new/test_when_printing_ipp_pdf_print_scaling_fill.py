...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test_classification:System
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_scaling_fill_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_scaling_fill
                +guid:2bc4df3a-dee8-4612-a1a0-f3b07b335bfa
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_scaling_fill_file_then_succeeds(self):
