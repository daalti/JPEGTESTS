...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_print_rendering_intent_relative_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:e3c57647-717a-4eb6-890e-137f59ffb5b0
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=URF & PrintProtocols=IPP
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_ipp_urf_print_rendering_intent_relative_file_then_succeeds(self):
        ipp_test_attribs = {}
