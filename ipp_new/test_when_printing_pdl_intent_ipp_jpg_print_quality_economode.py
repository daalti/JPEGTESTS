...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_jpg_print_quality_economode_file_then_succeeds
        +test:
            +title:test_pdl_intent_ipp_jpg_print_quality_economode
            +guid:636e8765-9a1a-448a-8339-b1d7f38e3ce5
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_jpg_print_quality_economode_file_then_succeeds(self):
        ipp_test_attribs = {}
