...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_print_content_optimize_graphics_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:0184f594-bf0d-4af1-a164-dc808cb04a7c
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_print_content_optimize_graphics_file_then_succeeds(self):
        ipp_test_attribs = {}
