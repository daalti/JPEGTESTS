...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_print_scaling_auto_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:f7a0ee41-9f38-4214-b0f6-cd6f487a1f1d
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=URF & PrintProtocols=IPP
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_ipp_urf_print_scaling_auto_file_then_succeeds(self):
        ipp_test_attribs = {}
