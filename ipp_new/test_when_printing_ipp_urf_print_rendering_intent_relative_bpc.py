...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_print_rendering_intent_relative_bpc_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c2be4886-b854-4e4d-b9de-208b1be430b6
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_print_rendering_intent_relative_bpc_file_then_succeeds(self):
        ipp_test_attribs = {}
