...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_scaling_none_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:0fa076f9-7a79-4f22-87b1-84a4628f5dc3
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_scaling_none_file_then_succeeds(self):
