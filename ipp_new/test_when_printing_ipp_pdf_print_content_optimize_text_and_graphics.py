...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_content_optimize_text_and_graphics_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_content_optimize_text_and_graphics
                    +guid:5887a17b-491a-4c4f-9682-d74a7b7bc3d0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_content_optimize_text_and_graphics_file_then_succeeds(self):
