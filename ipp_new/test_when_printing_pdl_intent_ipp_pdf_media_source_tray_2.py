...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_pdf_media_source_tray_2_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:4d6020c6-5fff-44a4-83e9-4a6a4840fe03
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_pdf_media_source_tray_2_file_then_succeeds(self):
        ipp_test_attribs = {}
