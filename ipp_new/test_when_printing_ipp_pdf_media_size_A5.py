...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_size_A5_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_size_A5
                    +guid:f475aec3-db30-4507-a9d2-d69844d7f246
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_size_A5_file_then_succeeds(self):
