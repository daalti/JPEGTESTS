...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_source_tray_1_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_source_tray_1
                    +guid:1192a575-92d0-40ea-8e22-ba8191acc415
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_source_tray_1_file_then_succeeds(self):
