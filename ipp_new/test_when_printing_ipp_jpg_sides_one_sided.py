...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_sides_one_sided_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_sides_one_sided
            +guid:96843d21-e9dd-4277-9624-3442eba9e772
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_sides_one_sided_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'sides': 'one-sided'}
