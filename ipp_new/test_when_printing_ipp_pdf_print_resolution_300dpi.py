...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test_classification:System
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_resolution_300dpi_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_resolution_300dpi
                +guid:59a2942c-1f79-4ec2-8a45-a52f96ce903e
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_resolution_300dpi_file_then_succeeds(self):
