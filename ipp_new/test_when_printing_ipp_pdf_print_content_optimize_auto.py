...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_content_optimize_auto_file_then_succeeds
        +test:
            +title:test_ipp_pdf_print_content_optimize_auto
                    +guid:0362f528-761d-43a8-9ba8-5a24a05b748c
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_content_optimize_auto_file_then_succeeds(self):
