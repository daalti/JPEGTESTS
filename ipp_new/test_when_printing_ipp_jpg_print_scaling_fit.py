...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose:C51669523 IPP test for printing a JPG file using attribute value print-scaling_fit.
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_scaling_fit_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_print_scaling_fit
            +guid:8e155539-c2c1-4fcf-9dd2-404edc7e3626
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_scaling_fit_file_then_succeeds(self):
        self.outputsaver.operation_mode('TIFF')
        self.outputsaver.validate_crc_tiff()
        ipp_test_attribs = {'document-format': 'image/jpeg', 'scaling': 'fit'}
