...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_color_mode_color_image_prints_in_color_file_then_succeeds
        +test:
            +title:test_ipp_pclm_color_mode_color_image_prints_in_color
            +guid:a9008698-bd2d-4be3-8b4a-fff4d575ff75
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_color_mode_color_image_prints_in_color_file_then_succeeds(self):
