...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value print-color-mode_auto.
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_color_mode_auto_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_print_color_mode_auto
            +guid:c776dbd5-adb7-4e43-a747-bbf765fe4150
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_color_mode_auto_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        ipp_test_attribs = {'document-format': 'image/jpeg', 'print-color-mode': 'auto'}
