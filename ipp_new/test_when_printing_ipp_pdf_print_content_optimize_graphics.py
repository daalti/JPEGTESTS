...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_content_optimize_graphics_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_content_optimize_graphics
                    +guid:86de852e-2294-4af0-9ab8-cc4bf0fc9f39
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_content_optimize_graphics_file_then_succeeds(self):
