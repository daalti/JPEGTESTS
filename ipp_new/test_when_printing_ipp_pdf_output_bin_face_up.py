...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_output_bin_face_up_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_output_bin_face_up
                    +guid:bb8200ee-dfaf-463a-9cbe-6112f117c7c3
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_output_bin_face_up_file_then_succeeds(self):
