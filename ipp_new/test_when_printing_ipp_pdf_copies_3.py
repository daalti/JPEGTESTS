...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_copies_3_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_copies_3
                    +guid:deda1069-392b-490e-bd3d-cf29b9eb9bbb
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_copies_3_file_then_succeeds(self):
