...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value test_ipp_jpg_print_content_optimize_photo
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_content_optimize_photo_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_print_content_optimize_photo
            +guid:9793f472-0ebe-45c3-ba91-0951001868d3
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_content_optimize_photo_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'print-content-optimize': 'photo'}
