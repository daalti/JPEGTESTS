...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test_classification:System
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_rendering_intent_auto_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_rendering_intent_auto
                +guid:39fd194b-5d33-4e75-8f8c-ffc0ae9de51f
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_rendering_intent_auto_file_then_succeeds(self):
