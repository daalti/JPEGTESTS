...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_orientation_none_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_orientation_none
                    +guid:729677be-c85b-4d27-b4f2-90cfcdb2c779
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_orientation_none_file_then_succeeds(self):
