...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_color_mode_process_monochrome_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:2beae4f1-75f5-4d2a-927e-75dc3792d3b0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_color_mode_process_monochrome_file_then_succeeds(self):
