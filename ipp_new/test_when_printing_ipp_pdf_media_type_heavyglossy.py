...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_type_heavyglossy_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_type_heavyglossy
                    +guid:f11feb14-f365-4d72-addc-3634d3a5cea8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_type_heavyglossy_file_then_succeeds(self):
