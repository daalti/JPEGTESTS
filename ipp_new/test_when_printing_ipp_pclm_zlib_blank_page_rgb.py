...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_zlib_blank_page_rgb_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pclm_zlib_blank_page_rgb
                    +guid:bd849bc6-dd94-48c2-b4ef-6d529d2a12b6
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_zlib_blank_page_rgb_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        ipp_test_file = self.print.ipp.generate_test_file_path()
        job_id = self.print.ipp.start(ipp_test_file, '28ced94ad4ff4ec8a5b0076ab5524e5fa9665c095e1bb7ec6552b71aacef00f0')
