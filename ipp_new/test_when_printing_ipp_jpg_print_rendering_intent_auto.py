...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value print_rendering_intent_auto
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_rendering_intent_auto_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_print_rendering_intent_auto
            +guid:5386ef66-5333-4445-bdbb-ad238d753ba6
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_rendering_intent_auto_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'print-rendering-intent': 'auto'}
