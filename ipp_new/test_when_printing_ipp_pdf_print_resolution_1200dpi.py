...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test_classification:System
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_resolution_1200dpi_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_resolution_1200dpi
                +guid:fc338bb5-cb38-4862-bf3c-a318292c54c9
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_resolution_1200dpi_file_then_succeeds(self):
