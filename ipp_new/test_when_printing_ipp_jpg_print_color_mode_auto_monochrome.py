...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_color_mode_auto_monochrome_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c8206dc9-f1ff-46b3-86d1-ff95040350f8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_color_mode_auto_monochrome_file_then_succeeds(self):
