...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value orientation-requested_none.
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_orientation_requested_none_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_orientation_requested_none
            +guid:33183e1b-a390-4ba1-b74f-9115da8176bc
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_orientation_requested_none_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'orientation-requested': 7}
