...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_size_legal_file_then_succeeds
        +test:
            +title:test_ipp_pdf_media_size_legal
                    +guid:30657554-2a8e-4a9f-a07b-22a5bc1b44d2
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=PDF & PrintProtocols=IPP & MediaSizeSupported=na_legal_8.5x14in
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_ipp_pdf_media_size_legal_file_then_succeeds(self):
