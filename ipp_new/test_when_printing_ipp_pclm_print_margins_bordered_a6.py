...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_print_margins_bordered_a6_file_then_succeeds
        +test:
            +title:test_ipp_pclm_print_margins_bordered_a6
                    +guid:1ebe7bcf-7a02-41ce-8f4a-5bae845108c8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_print_margins_bordered_a6_file_then_succeeds(self):
