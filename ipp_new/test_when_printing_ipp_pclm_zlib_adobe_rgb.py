...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_zlib_adobe_rgb_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pclm_zlib_adobe_rgb
                    +guid:85d758a2-1374-442c-912c-32d4a6e9c3c5
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_zlib_adobe_rgb_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        ipp_test_file = self.print.ipp.generate_test_file_path()
        job_id = self.print.ipp.start(ipp_test_file, 'ecdfcba17c66d36cbe68e2dba8cfa208d4692d8e43daf9021626e8e97a36a763')
