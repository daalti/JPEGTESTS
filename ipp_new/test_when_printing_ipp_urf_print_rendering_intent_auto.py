...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_print_rendering_intent_auto_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:284f5a2d-7a3a-428b-8de6-eda8e68c6fda
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=URF & PrintProtocols=IPP
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_ipp_urf_print_rendering_intent_auto_file_then_succeeds(self):
        ipp_test_attribs = {}
