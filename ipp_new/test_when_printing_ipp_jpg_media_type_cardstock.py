...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_media_type_cardstock_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:baf81723-979c-40ab-85ed-a27786e54446
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_media_type_cardstock_file_then_succeeds(self):
