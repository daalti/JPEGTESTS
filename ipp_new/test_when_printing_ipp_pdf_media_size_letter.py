...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_size_letter_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_size_letter
                    +guid:b9df18b7-0814-465c-8619-58b2cc6b9388
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_size_letter_file_then_succeeds(self):
