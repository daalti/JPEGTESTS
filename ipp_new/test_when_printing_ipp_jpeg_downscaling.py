...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a 1200 JPG file using attribute value printquality draft.
        +test_tier:1
        +is_manual:False
        +timeout:600
        +asset:PDL_New
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpeg_downscaling_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpeg_downscaling
            +guid:cddf5a3e-963e-42b8-b1e8-38970e83571d
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpeg_downscaling_file_then_succeeds(self):
