...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_print_content_optimize_photo_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:37f5df14-b997-4626-8551-3a03c9871f6f
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_print_content_optimize_photo_file_then_succeeds(self):
        ...
        job_id = self.print.ipp.start(ipp_test_file, '8871af83efe1b22416f963440859339286d88d07d610f8a3ad64a54834c344fc')
