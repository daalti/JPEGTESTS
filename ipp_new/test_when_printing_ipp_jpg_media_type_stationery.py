...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value media-type_stationery.
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_media_type_stationery_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_media_type_stationery
            +guid:1ded9db7-1581-445b-9cd1-b0b8655e653d
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_media_type_stationery_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'media-type': 'stationery'}
