...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_jpg_media_size_A4_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:3db29f5b-4165-4b7f-b80f-d5614a36c516
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_jpg_media_size_A4_file_then_succeeds(self):
        ipp_test_attribs = {}
