...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_scaling_auto_fit_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:7ef7cb82-6c92-4085-8733-9ed922b436a8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_scaling_auto_fit_file_then_succeeds(self):
