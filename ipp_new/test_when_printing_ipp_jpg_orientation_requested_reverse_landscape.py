...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_orientation_requested_reverse_landscape_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:d05cc361-71c0-4b38-a466-ec37b73670c8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_orientation_requested_reverse_landscape_file_then_succeeds(self):
        ...
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_attributes)
