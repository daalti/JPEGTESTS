...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_pclm_two_sided_short_edge_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:6cdd6eeb-ecb1-4e0d-8ab8-badc88ba9497
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_pclm_two_sided_short_edge_file_then_succeeds(self):
        ipp_test_attribs = {}
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_test_attribs)

        job_id = self.print.ipp.start(ipp_test_file, '545dc0ec40f3024ca0c3b369d252292f76daab8ad5fc4370b70811e81ac6c351')
