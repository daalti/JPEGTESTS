...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose:C51669522 IPP test for printing a JPG file using attribute value print-scaling_fill.
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_scaling_fill_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_print_scaling_fill
            +guid:73e28461-5d0e-482e-a8f2-f35de97c4efc
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_scaling_fill_file_then_succeeds(self):
        self.outputsaver.operation_mode('TIFF')
        self.outputsaver.validate_crc_tiff()
        ipp_test_attribs = {'document-format': 'image/jpeg', 'scaling': 'fill'}
