...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_print_margins_jpeg_marginned_pclm_documents_file_then_succeeds
        +test:
            +title:test_ipp_pclm_print_margins_jpeg_marginned_pclm_documents
                    +guid:86e0ebc3-6ae3-4671-abdf-f90a8d56005d
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_print_margins_jpeg_marginned_pclm_documents_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        ipp_test_file = self.print.ipp.generate_test_file_path()
        job_id = self.print.ipp.start(ipp_test_file, '69755b2208e722c35b95401ffd9f4a2e5e0641ff214d620b47002918161be339')
