...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value copies_2.
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_copies_2_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_copies_2
            +guid:667b18e3-cf35-47fb-9de9-a815309860b1
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_copies_2_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'copies': 2}
