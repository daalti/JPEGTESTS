...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_rendering_intent_perceptual_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c2b5ca06-b67b-45f6-bb74-3b9cb8519344
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_rendering_intent_perceptual_file_then_succeeds(self):
