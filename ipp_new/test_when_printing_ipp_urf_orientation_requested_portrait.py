...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +external_files:Letter_Color_600.urf=6f574dcc72506c503075530d8e6a9695a466657ddb552ccc4afbab95c54b4c0f
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_orientation_requested_portrait_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_urf_orientation_requested_portrait
                +guid:c9eddd8b-e1be-42b4-a782-7a5948ce608c
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_orientation_requested_portrait_file_then_succeeds(self):
