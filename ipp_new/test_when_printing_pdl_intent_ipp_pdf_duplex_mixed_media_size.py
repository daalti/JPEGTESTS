...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_pdf_duplex_mixed_media_size_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:3fbeeb61-e907-4a4e-910b-21deb27daa22
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_pdf_duplex_mixed_media_size_file_then_succeeds(self):
        ipp_test_attribs = {}
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_test_attribs)

        job_id = self.print.ipp.start(ipp_test_file, 'af68b3e3cff3970aef1e9b0758eb6bfcaaed196ca25575106b40e56f54e145df')
