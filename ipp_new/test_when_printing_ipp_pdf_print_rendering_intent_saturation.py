...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test_classification:System
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_rendering_intent_saturation_file_then_succeeds
        +test:
            +title:test_ipp_pdf_print_rendering_intent_saturation
                +guid:b785a221-ad69-4ae9-a1ea-fa01675173e8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_rendering_intent_saturation_file_then_succeeds(self):
