...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_pdf_media_source_must_honor_autoselect_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:28a7fb17-e252-4166-ab37-137a0b02bb15
            +dut:
                +type: Simulator
                +configuration: DocumentFormat=PDF & PrintProtocols=IPP & PrintColorMode=Color & Print=Normal
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_pdl_intent_ipp_pdf_media_source_must_honor_autoselect_file_then_succeeds(self):
        ipp_test_attribs = {}
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_test_attribs)

        job_id = self.print.ipp.start(ipp_test_file, '1e210be55fe0a9428180ba42bb70db84fa3e273d3d121d1b67deebf806f5c41d')
