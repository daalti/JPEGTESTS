...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +external_files:Letter_Color_600.urf=6f574dcc72506c503075530d8e6a9695a466657ddb552ccc4afbab95c54b4c0f
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_print_color_mode_auto_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_urf_print_color_mode_auto
                +guid:d4b19a4b-801c-484c-b7b1-3be4e8dc1b73
            +dut:
                +type:Simulator
                +configuration:DocumentFormat=URF & PrintProtocols=IPP
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_ipp_urf_print_color_mode_auto_file_then_succeeds(self):
