...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_type_stationery_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_type_stationery
                    +guid:b3bb72cd-b1d6-482a-8d7d-598f63cf4c91
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_type_stationery_file_then_succeeds(self):
