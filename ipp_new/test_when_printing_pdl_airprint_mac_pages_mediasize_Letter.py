...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_airprint_mac_pages_mediasize_Letter_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:6d59acfb-5a41-4d48-a500-9e82bc4f72e4
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_airprint_mac_pages_mediasize_Letter_file_then_succeeds(self):
        ipp_test_attribs = {}
        ipp_test_file = self.print.ipp.generate_test_file_path(**ipp_test_attribs)

        job_id = self.print.ipp.start(ipp_test_file, '9464f40b9055c57e8f5f0abed54a2e7896e7dd0bc30ed423d469345efb6a1300')
