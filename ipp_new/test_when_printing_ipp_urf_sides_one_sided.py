...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose:Ipp test for printing a URF file using attribute value sides_one-sided
        +test_tier:1
        +is_manual:False
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_sides_one_sided_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_sides_one_sided
            +guid:6cb681b3-5067-49d6-bc65-1edc444a82fa
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_sides_one_sided_file_then_succeeds(self):
        ipp_test_attribs = {}
