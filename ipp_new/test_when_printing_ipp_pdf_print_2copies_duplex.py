...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_2copies_duplex_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_2copies_duplex
                    +guid:1f8bf428-819a-4e7a-99af-491fdb1937aa
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_2copies_duplex_file_then_succeeds(self):
