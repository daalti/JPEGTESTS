...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_type_cardstock_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_type_cardstock
                    +guid:6637b5b7-45ac-4bc3-8cfd-0b799ae831b8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_type_cardstock_file_then_succeeds(self):
