...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_copies_10_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_copies_10
                    +guid:4e2129ff-bed1-4a96-a059-acf2d4121974
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_copies_10_file_then_succeeds(self):
