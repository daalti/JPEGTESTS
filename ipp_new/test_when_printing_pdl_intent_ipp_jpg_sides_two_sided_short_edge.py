...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_jpg_sides_two_sided_short_edge_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:944d64ff-fbd0-47e1-9090-684ec5c10a0c
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_jpg_sides_two_sided_short_edge_file_then_succeeds(self):
        ipp_test_attribs = {}
