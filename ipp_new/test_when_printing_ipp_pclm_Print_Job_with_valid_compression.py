...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_Print_Job_with_valid_compression_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_pclm_Print_Job_with_valid_compression
            +guid:0d9bd451-674c-444b-a42e-48441a408e9e
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_Print_Job_with_valid_compression_file_then_succeeds(self):
        self.outputsaver.operation_mode('TIFF')
        ipp_test_attribs = {'document-format': 'application/PCLm', 'compression': 'none'}
