...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_long_edge_duplex_single_page_file_then_succeeds
        +test:
            +title:test_ipp_pclm_long_edge_duplex_single_page
            +guid:fb6a480e-6ebb-4a38-9f84-07aeecd5a2fd
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_long_edge_duplex_single_page_file_then_succeeds(self):
