...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_media_size_A4_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_media_size_A4
                    +guid:0b987910-af68-4852-bec5-db45fd9eca00
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_media_size_A4_file_then_succeeds(self):
