...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +test_classification:System
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_print_scaling_auto_fit_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_print_scaling_auto_fit
                +guid:b2da72ba-d993-43dc-b087-2f214f4440f6
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_print_scaling_auto_fit_file_then_succeeds(self):
