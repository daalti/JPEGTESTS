...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_print_margins_zlib_marginned_pclm_documents_file_then_succeeds
        +test:
            +title:test_ipp_pclm_print_margins_zlib_marginned_pclm_documents
                    +guid:b1b98caa-e506-46f6-8173-e8dffaf13123
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_print_margins_zlib_marginned_pclm_documents_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        ipp_test_file = self.print.ipp.generate_test_file_path()
        job_id = self.print.ipp.start(ipp_test_file, 'f64abd0480441505d7d406346ac765c856c0f305ac6a938b8c1322f5c7384176')
