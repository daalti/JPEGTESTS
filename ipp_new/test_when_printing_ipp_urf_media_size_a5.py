...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +external_files:A4_Color_600.urf=2dbe67f5a803639fd902f1a097d90b287de362650cd198829801c9f477337ff0
            +name:TestWhenPrintingIPPFile::test_when_using_ipp_urf_media_size_a5_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_urf_media_size_a5
                +guid:e5208903-9ec9-4e37-a5fa-64c5a51654f0
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_urf_media_size_a5_file_then_succeeds(self):
