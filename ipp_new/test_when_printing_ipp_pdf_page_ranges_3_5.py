...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pdf_page_ranges_3_5_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            +title:test_ipp_pdf_page_ranges_3_5
                    +guid:a9be870c-3dbd-415e-be48-492fbac406be
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pdf_page_ranges_3_5_file_then_succeeds(self):
