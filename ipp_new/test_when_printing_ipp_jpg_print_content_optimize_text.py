...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose: IPP test for printing a JPG file using attribute value print_content_optimize_text
        +test_tier:1
        +is_manual:False
        +reqid:DUNE-47064
        +timeout:120
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_print_content_optimize_text_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_jpg_print_content_optimize_text
            +guid:106c1c24-c998-4f55-ab09-5592a127bd10
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_print_content_optimize_text_file_then_succeeds(self):
        ipp_test_attribs = {'document-format': 'image/jpeg', 'print-content-optimize': 'text'}
