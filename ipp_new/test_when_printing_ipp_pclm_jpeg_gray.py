...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        +purpose:C52177667 Ipp test for printing a PCLm file using attribute value media-size_letter
        +test_tier:1
        +is_manual:False
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_jpeg_gray_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
            ...
            +test_type:Positive
        +test:
            +title:test_ipp_pclm_jpeg_gray
            +guid:082d00d9-c667-4f32-8b98-d69e1b5f8521
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_jpeg_gray_file_then_succeeds(self):
