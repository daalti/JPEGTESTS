...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_orientation_unsupport_ipp_fidelity_false_file_then_succeeds
        +test:
            +title:test_ipp_pclm_orientation_unsupport_ipp_fidelity_false
            +guid:c4961635-0766-40a0-9c31-de3e8fc48bf3
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_orientation_unsupport_ipp_fidelity_false_file_then_succeeds(self):
