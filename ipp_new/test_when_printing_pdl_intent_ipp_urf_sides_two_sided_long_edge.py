...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_pdl_intent_ipp_urf_sides_two_sided_long_edge_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c8c95d9e-b173-41bd-bc04-6b314ca153f4
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_ipp_urf_sides_two_sided_long_edge_file_then_succeeds(self):
        ipp_test_attribs = {}
