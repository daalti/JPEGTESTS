...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_output_bin_face_up_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:c030fcd0-44f2-46eb-94f1-e618e9e0ae6d
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_output_bin_face_up_file_then_succeeds(self):
