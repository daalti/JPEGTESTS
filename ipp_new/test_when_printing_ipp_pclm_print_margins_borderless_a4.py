...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_pclm_print_margins_borderless_a4_file_then_succeeds
        +test:
            +title:test_ipp_pclm_print_margins_borderless_a4
                    +guid:c70736fe-397d-4264-a361-e30b260fed22
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_pclm_print_margins_borderless_a4_file_then_succeeds(self):
        self.outputsaver.validate_crc_tiff()
        ipp_test_file = self.print.ipp.generate_test_file_path()
        job_id = self.print.ipp.start(ipp_test_file, '2b931e5448da2b6fbce96b836971a0f9008a4d24e0158f4a6c08aec3d288c189')
