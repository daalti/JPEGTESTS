...
class TestWhenPrintingFileFromIPP(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingIPPFile::test_when_using_ipp_jpg_page_ranges_3_5_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:056a50f7-fedc-4a31-8d4e-bd66eace10d8
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_ipp_jpg_page_ranges_3_5_file_then_succeeds(self):
