...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl3gui_4x6_PgB_Borderless_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:22bea92a-a988-4b17-93f9-5747c3bd3cf6
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pcl3gui_4x6_PgB_Borderless_file_then_succeeds(self):
        ...
        if self.media.tray.is_media_combination_supported(default, 'na_index-4x6_4x6in', 'com.hp-photographic-glossy'):
            ...
            job_id = self.print.raw.start('1c10ea84f73b42be5abd5d72c2b78500401baadfc19a1e84fa58b121c49e5a24')
