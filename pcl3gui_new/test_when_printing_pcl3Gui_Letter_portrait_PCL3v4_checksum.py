...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
            ...
            +name:TestWhenPrintingJPEGFile::test_when_using_pcl3Gui_Letter_portrait_PCL3v4_checksum_file_then_succeeds
            +test:
                +title:test_pcl3Gui_Letter_portrait_PCL3v4_checksum
                +guid:26b9f379-46a2-4134-a745-52b70810f772
                +dut:
                    +type:Simulator, Emulator
                    +configuration:PrintEngineType=Maia & DocumentFormat=PCL3GUI
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_pcl3Gui_Letter_portrait_PCL3v4_checksum_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('6568e2ca2862e40d807c9c3a749434fa0d4b14143bdbb2019d68c1324f83807b')
