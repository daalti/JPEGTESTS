...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pdl_intent_pcl3gui_b4_gray_oversize_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:f3b58b5b-d120-4339-b240-c0a694288f17
            +dut:
                +type:Simulator
    ...
    """
    def test_when_using_pdl_intent_pcl3gui_b4_gray_oversize_file_then_succeeds(self):

        self.outputsaver.validate_crc_tiff()

        job_id = self.print.raw.start('db1688716e505c4ebffcf269d0fd10be780aa1c0fd0e55a2ced7394f9be3379d')
