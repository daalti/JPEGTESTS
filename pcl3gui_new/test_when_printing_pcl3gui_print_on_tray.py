...
class TestWhenPrintingJPEGFile(TestWhenPrinting):
    ...
    $$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
        ...
        +name:TestWhenPrintingJPEGFile::test_when_using_pcl3gui_print_on_tray_file_then_succeeds
        +categorization:
            +segment:Platform
            +area:Print
            +feature:PDL
        ...
        +test:
            ...
            +guid:ce69ee2c-c931-4d23-907e-675a50daf11e
            +dut:
                +type:Simulator
                +configuration: DocumentFormat=PCL3GUI&DeviceClass=MFP
    $$$$$_END_TEST_METADATA_DECLARATION_$$$$$
    """
    def test_when_using_pcl3gui_print_on_tray_file_then_succeeds(self):
        ...
        job_id = self.print.raw.start('810d550f6192b94db7340887f7497f228c506acd279dc4aaa2ce7d2230e2c4cb')
