...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_content_optimize_text_and_graphics
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:78a46c01-65fa-43fc-8f73-d6fb96a8647a
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_content_optimize_text_and_graphics(setup_teardown, printjob, outputsaver, tray):
