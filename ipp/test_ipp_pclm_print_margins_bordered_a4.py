...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_pclm_print_margins_bordered_a4
    +test:
        +title:test_ipp_pclm_print_margins_bordered_a4
        +guid:7d3a166d-4ff4-4ddd-b4da-ec22f6d87fb1
        +dut:
            +type:Simulator
...
"""
def test_ipp_pclm_print_margins_bordered_a4(setup_teardown, ews, net, printjob, outputsaver, tray, udw, close_ews, reset_tray):
