...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_content_optimize_photo
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:60c77d32-3632-48ba-9181-98578d3912b8
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_content_optimize_photo(setup_teardown, printjob, outputsaver, tray):
