...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_pclm_output_bin_face_down_fedility_default
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:efbf721c-5a54-4724-95a8-6183b4bdd441
        +dut:
            +type:Simulator
...
"""
def test_ipp_pclm_output_bin_face_down_fedility_default(setup_teardown, printjob, outputverifier,tray, outputsaver):
...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +test_classification:System
    +name:test_ipp_pclm_output_bin_face_down_fedility_default_pclm_letter_600_cjpeg_h64_pgcnt1_rgb
    +test:
        +title:test_ipp_pclm_output_bin_face_down_fedility_default_pclm_letter_600_cjpeg_h64_pgcnt1_rgb
        +guid:35ba54a7-bfc8-400e-a8ee-1028c85d5e28
        +dut:
            +type:Simulator
...
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_ipp_pclm_output_bin_face_down_fedility_default_pclm_letter_600_cjpeg_h64_pgcnt1_rgb(setup_teardown, printjob, outputverifier,tray, outputsaver, udw, reset_tray):
