...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_content_optimize_text
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:f0ab3373-beeb-4a62-8f29-99a9a7011092
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_content_optimize_text(setup_teardown, printjob, outputsaver, tray):
