...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_pclm_Print_Job_with_valid_compression
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:c1e9b193-2d44-4d21-94a0-aeb5843a8e1d
        +dut:
            +type:Simulator
...
"""
def test_ipp_pclm_Print_Job_with_valid_compression (setup_teardown, printjob, outputverifier,outputsaver):
