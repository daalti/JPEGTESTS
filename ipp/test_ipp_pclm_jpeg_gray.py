...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +test:
        ...
        +guid:b5d6671e-9e0d-419d-a2fe-afaf6a2b1fee
        +dut:
            +type:Simulator
...
"""
def test_ipp_pclm_jpeg_gray(setup_teardown, printjob, outputverifier, outputsaver, udw):
