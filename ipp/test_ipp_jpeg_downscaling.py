...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpeg_downscaling
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:a1e7dce3-5997-4d7e-b5ca-14194322a739
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpeg_downscaling(setup_teardown, printjob, outputsaver, tray,cdm,configuration):
