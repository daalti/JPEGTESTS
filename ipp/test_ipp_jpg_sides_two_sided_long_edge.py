...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_sides_two_sided_long_edge
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:6161cb23-6690-4f66-9543-28902ebf48c8
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_sides_two_sided_long_edge(setup_teardown, printjob, outputsaver, tray):
