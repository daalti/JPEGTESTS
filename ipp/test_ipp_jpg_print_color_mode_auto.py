...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_color_mode_auto
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:c59cee06-24b9-4211-b69b-8b24ae011168
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_color_mode_auto(setup_teardown, printjob, outputsaver, udw, tray):
