...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pdl_apvt_dft2_urf_mixedheader_deviceRGB_devicegray_duplex_nomedia_speci_file29
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
        ...
        +test_type:Positive
    +test:
        +title:test_pdl_apvt_dft2_urf_mixedheader_deviceRGB_devicegray_duplex_nomedia_speci_file29
        +guid:4def50e7-c31c-44e6-b6cb-31da7aee7d01
        +dut:
            +type:Simulator
            +configuration: DocumentFormat=URF & PrintProtocols=IPP & EngineFirmwareFamily=Canon & Certifications=AirPrint
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_pdl_apvt_dft2_urf_mixedheader_deviceRGB_devicegray_duplex_nomedia_speci_file29(setup_teardown, printjob, outputsaver):
