...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_rendering_intent_relative
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:4687debd-9aa7-426e-8b10-6fc2a3e1dff5
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_rendering_intent_relative(setup_teardown, printjob, outputsaver, tray):
