...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_rendering_intent_relative_bpc
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:5adf8901-3ceb-44d4-94b5-9c77596c1d0d
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_rendering_intent_relative_bpc(setup_teardown, printjob, outputsaver, tray):
