...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_pdf_page_ranges_1_1
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:e287a952-88eb-4264-9e9e-e8a4c2d49c2f
...
"""
def test_ipp_pdf_page_ranges_1_1(setup_teardown, printjob, outputsaver, udw):
    outputsaver.operation_mode('TIFF')
    outputsaver.validate_crc_tiff(udw)
    ipp_test_attribs = {'document-format': 'application/pdf', 'page-ranges': '1-1'}
