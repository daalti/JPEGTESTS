...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_pclm_print_content_optimize_graphics
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:6d0fc6bb-a05f-4812-9037-1d2f3e4b1c5c
        +dut:
            +type:Simulator
            +configuration:DocumentFormat=PCLm & PrintProtocols=IPP
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_ipp_pclm_print_content_optimize_graphics(setup_teardown, printjob, outputverifier, outputsaver):
...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +test_classification:System
    +name:test_ipp_pclm_print_pclm_letter_600_cjpeg_h64_pgcnt1_rgb_graphics
    +test:
        +title:test_ipp_pclm_print_pclm_letter_600_cjpeg_h64_pgcnt1_rgb_graphics
        +guid:037b6895-0658-4f4b-aed3-86bb4aa9c839
        +dut:
            +type:Simulator
            +configuration:DocumentFormat=PCLm & PrintProtocols=IPP
    +overrides:
...
$$$$$_END_TEST_METADATA_DECLARATION_$$$$$
"""
def test_ipp_pclm_print_pclm_letter_600_cjpeg_h64_pgcnt1_rgb_graphics(setup_teardown, printjob, outputverifier, outputsaver, udw):
    outputsaver.validate_crc_tiff(udw)

    print_file = printjob.get_file('5d2c2739f4126a4a74d3a9da7d3d261255f572999dd4abd3957f734561c0c240')
