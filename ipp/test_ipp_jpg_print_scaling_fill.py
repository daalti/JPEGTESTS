...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_scaling_fill
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:fc9451a6-98a8-417e-9ff5-e4228980f8d0
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_scaling_fill(setup_teardown, printjob, outputsaver, tray, udw, reset_tray):
