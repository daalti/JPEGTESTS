...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_scaling_auto
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:5a762d7f-4e01-4548-81ec-922969470378
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_scaling_auto(setup_teardown, printjob, outputsaver, tray):
