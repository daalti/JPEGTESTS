...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    +purpose: IPP test for printing a pdf file using attribute value copies_3
    +test_tier:1
    +is_manual:False
    +reqid:DUNE-47064
    +timeout:120
    ...
    +categorization:
        ...
        +test_type:Positive
    +test:
        +title:test_ipp_pdf_copies_3
        +guid:b6466aa1-2162-442c-a474-6aeb09adf0b6
        +dut:
            +type:Simulator
...
"""
def test_ipp_pdf_copies_3(setup_teardown, printjob, outputverifier, outputsaver):
    outputsaver.operation_mode('TIFF')
    ipp_test_attribs = {'document-format': 'application/pdf', 'copies': 3}
