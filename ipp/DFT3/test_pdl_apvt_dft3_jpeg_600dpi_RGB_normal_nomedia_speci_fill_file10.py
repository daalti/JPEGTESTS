...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pdl_apvt_dft3_jpeg_600dpi_RGB_normal_nomedia_speci_fill_file10
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
        ...
        +test_type:Positive
    +test:
        +title:test_pdl_apvt_dft3_jpeg_600dpi_RGB_normal_nomedia_speci_fill_file10
        +guid:4c2d0e8a-3a05-4ba4-8170-5c6e53fb1763
        +dut:
            +type:Simulator
...
"""
def test_pdl_apvt_dft3_jpeg_600dpi_RGB_normal_nomedia_speci_fill_file10(setup_teardown, printjob, outputsaver,tray,udw):
