...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_quality_normal
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:0926270e-638b-411d-8b8b-fabd930a28cf
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_quality_normal(setup_teardown, printjob, outputsaver, tray):
