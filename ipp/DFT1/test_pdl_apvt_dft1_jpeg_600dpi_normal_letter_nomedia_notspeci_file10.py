...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pdl_apvt_dft1_jpeg_600dpi_normal_letter_nomedia_notspeci_file10
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
        ...
        +test_type:Positive
    +test:
        +title:test_pdl_apvt_dft1_jpeg_600dpi_normal_letter_nomedia_notspeci_file10
        +guid:6b408c23-347f-4ed7-8722-43d7793cab3c
        +dut:
            +type:Simulator
...
def test_pdl_apvt_dft1_jpeg_600dpi_normal_letter_nomedia_notspeci_file10(setup_teardown, printjob, outputsaver, udw):
