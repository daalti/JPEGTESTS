...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_pdl_apvt_dft1_pdf_600dpi_normal_letter_nomedia_notspeci_fit_file22
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
        ...
        +test_type:Positive
    +test:
        +title:test_pdl_apvt_dft1_pdf_600dpi_normal_letter_nomedia_notspeci_fit_file22
        +guid:8e5e9a7b-0c93-405f-baea-917974aac21c
        +dut:
            +type:Simulator
...
def test_pdl_apvt_dft1_pdf_600dpi_normal_letter_nomedia_notspeci_fit_file22(setup_teardown, printjob, outputsaver, udw):
