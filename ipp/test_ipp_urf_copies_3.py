...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    +purpose:Ipp test for printing a URF file using attribute value copies_3
    +test_tier:3
    +is_manual:False
    ...
    +categorization:
        ...
        +test_type:Positive
    +test:
        +title:test_ipp_urf_copies_3
        +guid:e036d060-d30e-4c43-b549-6fe374e34df3
        +dut:
            +type:Simulator
...
"""
def test_ipp_urf_copies_3(setup_teardown, printjob, outputsaver,udw):
    outputsaver.operation_mode('TIFF')
    REQUIRED_MEMORY = 52428800
    if printjob.printer_has_enough_pdl_memory(udw, REQUIRED_MEMORY):
        ipp_test_attribs = {'document-format': 'image/urf', 'copies': 3}
    else:
