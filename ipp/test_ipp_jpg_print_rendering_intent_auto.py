...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_print_rendering_intent_auto
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:90a73f29-5fb2-494e-8efb-31c60d1464ac
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_print_rendering_intent_auto(setup_teardown, printjob, outputsaver, tray):
