...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_ipp_jpg_media_type_stationery
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:f751eb98-d517-4e59-939c-675cbb9c2838
        +dut:
            +type:Simulator
...
"""
def test_ipp_jpg_media_type_stationery(setup_teardown, printjob, outputsaver, tray):
