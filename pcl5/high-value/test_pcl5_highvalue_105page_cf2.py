...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name: test_pcl5_highvalue_105page_cf2
    +test:
        +title: test_pcl5_highvalue_105page_cf2
        +guid:5251e25e-c627-4e47-b761-64a39b8bd2ad
        +dut:
            +type:Simulator
...
def test_pcl5_highvalue_105page_cf2(setup_teardown, printjob, outputsaver, print_emulation, configuration, tray):
    ...
    printjob.print_verify('d31350e23fd4d553e2c31bff37d41b00921c8530348705300b1e058d5f3cdfc5', timeout=2000)
