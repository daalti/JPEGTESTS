...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name: test_pdl_intent_ipp_pcl5_highvalue_4page_arial
    +categorization:
        +segment:Platform
        +area:Print
        +feature:PDL
    ...
    +test:
        ...
        +guid:7d232eb4-22a1-4731-b531-463fa3bb3bdf
        +dut:
            +type:Simulator
...
def test_pdl_intent_ipp_pcl5_highvalue_4page_arial(setup_teardown, printjob, outputsaver, outputverifier, tray):
    if tray.is_size_supported('na_executive_7.25x10.5in', 'tray-1'):
        tray.configure_tray('tray-1', 'na_executive_7.25x10.5in', 'stationery')
