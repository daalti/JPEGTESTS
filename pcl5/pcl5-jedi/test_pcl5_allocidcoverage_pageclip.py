...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name: test_pcl5_allocidcoverage_pageclip
    +test:
        +title: test_pcl5_allocidcoverage_pageclip
        +guid:f421d159-f636-4f16-9fc5-9e708e8e0c51
        +dut:
            +type:Simulator
...
def test_pcl5_allocidcoverage_pageclip(setup_teardown, printjob, outputsaver):
