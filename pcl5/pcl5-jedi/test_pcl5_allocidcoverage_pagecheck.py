...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name: test_pcl5_allocidcoverage_pagecheck
    +test:
        +title: test_pcl5_allocidcoverage_pagecheck
        +guid:2c3257b3-432e-44b5-ba07-d76d0924168b
        +dut:
            +type:Simulator
...
def test_pcl5_allocidcoverage_pagecheck(setup_teardown, printjob, outputsaver):
